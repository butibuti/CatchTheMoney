...
namespace ButiEngine {
	...
	private:
		...
		std::shared_ptr<RelativeTimer> shp_transitionTimer, shp_appleGather,shp_appleRotate, shp_appleMin,  shp_endTimer,shp_animationTimer, shp_FrameGenerateTimer, shp_appleGenerateTimer, shp_textGenerateTimer, shp_mouseGenerateTimer, shp_smileDaikokutenGenerateTimer,shp_startTimer;
