...
namespace ButiEngine {
	...
	public:
		...
		static void OutputLayoutCompileDx12(const std::string& source, const std::string& fileName);
		...
		static void CreateDx12PSOutputVector(const std::string& filePath, const std::string& source, std::vector<DXGI_FORMAT>& arg_vec_formats);
