...
namespace ButiEngine {
    ...
    namespace Easing {
        ...
        static const char*  EasingTypeNames[] = {
            "EaseIn"," EaseOut"," EaseInOut",
            "EaseInSin"," EaseOutSin"," EaseInOutSin",
            "EaseInQuad"," EaseOutQuad"," EaseInOutQuad",
            "EaseInCubic","EaseOutCubic"," EaseInOutCubic",
        ...
        static float EaseInSin(const float x) {
            return 1 - (float) std::cos((x * PI) / 2);
        }

        static float EaseOutSin(const float x) {
            return (float) std::sin((x * PI) / 2);
        }
        static float EaseInOutSin(const float x) {
            return -((float) std::cos(PI * x) - 1) / 2;
        }
        ...
        static float EaseOutBack(const float x) {
            ...
            return 1 + c3 * (float) std::pow(x - 1, 3) + c1 * (float) std::pow(x - 1, 2);
        }
        ...
        static float EaseInElastic(const float x) {
            ...
            return x == 0
                ...
                : x == 1
                ? 1
                : -(float) std::pow(2, 10 * x - 10) * (float) std::sin((x * 10 - 10.75) * c4);
        }
        static float EaseOutElastic(const float x) {
            ...
            return x == 0
                ...
                : x == 1
                ? 1
                : (float) std::pow(2, -10 * x) * (float) std::sin((x * 10 - 0.75) * c4) + 1;
        }
        ...
        static float EaseInOutElastic(const float x) {
            ...
            return x == 0
                ...
                ? 1
                : x < 0.5
                ? -((float) std::pow(2, 20 * x - 10) * (float) std::sin((20.0 * x - 11.125) * c5)) / 2
                : ((float) std::pow(2, -20 * x + 10) * (float) std::sin((20.0 * x - 11.125) * c5)) / 2 + 1;
        }
        static float EaseInQuint(const float x) {
            return x * x * x * x * x;
        }
        static float EaseOutQuint(const float x) {
            return 1 - (float) std::pow(1 - x, 5);
        }
        static float EaseInOutQuint(const float x) {
            return x < 0.5 ? 16 * x * x * x * x * x : 1 - (float) std::pow(-2 * x + 2, 5) / 2;
        }
        static float EaseInExpo(const float x) {
            return x == 0 ? 0 : (float) std::pow(2, 10 * x - 10);
        }
        static float EaseOutExpo(const float x) {
            return x == 1 ? 1 : 1 - (float) std::pow(2, -10 * x);
        }
        static float EaseInOutExpo(const float x) {
            return x == 0
                ...
                : x == 1
                ? 1
                : x < 0.5f ? (float) std::pow(2, 20 * x - 10) / 2
                : (2 - (float) std::pow(2, -20 * x + 10)) / 2;
        }
        static float Parabola(const float x) {
            return -(x - 0.5f) * (x - 0.5f) * 4 + 1;
        }
        ...
        static float CubeRotate90(const float x) {
            return (float) std::sin((x * 0.5f + 0.25f) * PI) - (float) std::sin((0.25f) * PI);
        }
        static float CubeRotate180(const float x) {
            return  CubeRotate90(x) * PI/2;
        }
        static float CubeRotateMin90(const float x) {
            return -((float) std::sin((x * 0.5 + 0.25) * PI) - (float) std::sin((0.25) * PI));
        }
        ...
        static float GetEase(float x, EasingType type) {
            return (EaseFunctions)[(unsigned int)type](x);
        }
