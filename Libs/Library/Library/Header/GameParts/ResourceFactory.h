...
public:
	...
	virtual	std::shared_ptr<Resource_Texture> CreateRenderTargetTexture(const UINT width, const UINT height, const int format)=0;
	virtual std::shared_ptr<Resource_Texture> CreateDepthStencilTexture(const UINT width, const UINT height) = 0;
	virtual std::shared_ptr<Resource_Texture> CreateEmptyTexture(const UINT width, const UINT height) = 0;
	...
	virtual std::shared_ptr<Resource_Material> CreateMaterial(const MaterialValue& arg_materialVar, const TextureTag& arg_textureTag) = 0;
	virtual std::shared_ptr<Resource_Material> CreateMaterial(const MaterialValue& arg_materialVar, const std::vector< TextureTag>& arg_textureTag) = 0;
	...
	virtual std::shared_ptr<Resource_Material> CreateMaterialList(const MaterialValue& arg_materialVar, const std::vector< TextureTag>& arg_textureTag,std::shared_ptr<IResourceContainer> arg_shp_resourceContainer )= 0;
